              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php $sql  = "SELECT * FROM surat_izin_keramaian ORDER BY nik ";
                      ...
                      <tr>
                        ...
                        <td align="center"> <?php echo $data['tokoh_pemuda'];?></td>
                        <td align="center"> <?php echo $data['tokoh_masyarakat'];?></td>
                        <td align="center"> <?php echo $data['tokoh_agama'];?></td>
                        <td align="center">
                          <a href="../<?php echo $data['file_surat']; ?>" target="_blank">
                            <img src="../<?php echo $data['file_surat']; ?>" class="col-sm-6 img-thumbnail" />
                          </a>
                        </td>
                        <td align="center"> <?php echo $data['deskripsi_surat'];?></td>
                        <td align="center">
                          <a href="confirm_hapus_buat_surat_izin_keramaian?id=<?php echo $data['id_keramaian']?>">
