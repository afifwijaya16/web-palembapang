...
<h3 align="center">Apakah Surat Domisili dengan ID Surat :<b> <i> <?php echo $id_surat_domisili ?></i></b> Ingin dihapus? </h3>

<h3 align="center">
    <a href="query_hapus_buat_surat_domisili?id=<?php echo $id_surat_domisili ?>">
