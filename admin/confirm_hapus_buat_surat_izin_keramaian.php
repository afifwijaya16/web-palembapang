...
<h3 align="center">Apakah Surat Izin Keramaian dengan ID Surat :<b> <i> <?php echo $id_keramaian ?></i></b> Ingin dihapus? </h3>

<h3 align="center">
    <a href="query_hapus_buat_surat_izin_keramaian?id=<?php echo $id_keramaian ?>">
